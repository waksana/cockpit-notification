...
**当前源码 0.1.7 使用主题感知未读底色，保留独立菜单项注册、增量同步与精简通知界面的正式功能。**
配套宿主为 Cockpit 0.2.4；目标 v0.1.7 资产须待 Release 实际发布，不以源码提交或功能确认代替发布。
具体源码覆盖和平台限制见实现说明。
...
| [发行说明](release-notes.md) | 开发变更 | 0.1.7 未读底色、保留的徽标/菜单/通知行为与已知限制 |
