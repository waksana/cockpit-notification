...
**0.1.3 增量同步与精简通知界面为正式功能。** GitHub Release 当前仍为 0.1.0，见对应 tag；
0.1.3 的固定源码构建安装与正式 Release 资产分别记录，不以功能确认代替发布。
具体源码覆盖和平台限制见实现说明。
...
| [发行说明](release-notes.md) | 开发变更 | 0.1.3 Edge 推送兼容、增量同步、精简入口与已知限制 |
