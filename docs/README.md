...
**当前源码 0.1.9 使用暖黄色小圆角未读底色与 1.6 秒淡出，保留独立菜单项注册、增量同步与精简通知界面的正式功能。**
配套宿主为 Cockpit 0.2.4；目标 v0.1.9 资产须待 Release 实际发布，不以源码提交或功能确认代替发布。
具体源码覆盖和平台限制见实现说明。
...
| [发行说明](release-notes.md) | 开发变更 | 0.1.9 小圆角与 1.6 秒淡出、保留的通知行为与已知限制 |
