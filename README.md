...
**当前源码版本为 0.1.10，配套 Cockpit 0.2.4，通知开关通过宿主独立菜单注册接入。**
0.1.10 将暖黄色未读底色淡出缩短到 1 秒，保留最多 3px 的圆角和先快后慢的 ease-out 曲线；
发布与安装状态仍以实际结果为准。
增量同步与精简通知界面是正式功能。目标安装资产须待
[v0.1.10 Release](https://github.com/waksana/cockpit-notification/releases/tag/v0.1.10) 实际发布后使用，
