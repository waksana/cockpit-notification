...
**当前源码版本为 0.1.14，要求独立 `uiSurfaceVersion: 1` 的配套宿主源码，通知开关仍通过宿主独立菜单注册接入。**
...
[v0.1.14 Release](https://github.com/waksana/cockpit-notification/releases/tag/v0.1.14) 实际发布后使用，
